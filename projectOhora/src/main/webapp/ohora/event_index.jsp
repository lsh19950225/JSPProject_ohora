					...
					<div class="eventPage" data-index="5">
						...
						<div class="event-list">
							<div class="contents-box active" style="display: block;">
								<a href="<%= contextPath %>/ohora.do?event=eventnew">
									<div class="image">
						...
						<div class="event-list">
							<div class="contents-box active" style="display: block;">
								<a href="<%= contextPath %>/ohora.do?event=eventvip8">
									<div class="image">
						...
						<div class="event-list">
							<div class="contents-box active" style="display: block;">
								<a href="<%= contextPath %>/ohora.do?event=eventvip7">
									<div class="image">
						...
						<div class="event-list">
							<div class="contents-box active" style="display: block;">
								<a href="<%= contextPath %>/ohora.do?event=gelnailtip">
									<div class="image">
						...
						<div class="event-list">
							<div class="contents-box">
								<a href="<%= contextPath %>/ohora.do?event=lesserafim">
									<div class="image">
						...
						<div class="event-list">
							<div class="contents-box">
								<a href="<%= contextPath %>/ohora.do?event=eventvip6">
									<div class="image">
						...
						<div class="event-list">
							<div class="contents-box">
								<a href="<%= contextPath %>/ohora.do?event=eventdayz">
									<div class="image">
						...
						<div class="event-list">
							<div class="contents-box">
								<a href="<%= contextPath %>/ohora.do?event=eventchoa">
									<div class="image">
