									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody>
											<tr>
												...
												<td>${topList.ord_id}<span></span>
												</td>
											</tr>
											<tr>
												<th scope="row">주문일자</th>
												<td>${topList.ord_orderdate}</td>
											</tr>
											<tr>
												<th scope="row">주문자</th>
												<td><span>${topList.ord_name}</span></td>
											</tr>
											<tr>
												<th scope="row">주문처리상태</th>
												<td class="SP_cm_btnChange"><span>${topList.opdt_state}</span>
													<button type="submit"
										...
										<tbody>
											<tr class="sum">
												...
												<td class="SP_cm_btnChange"><span class="gSpace20">
														<strong class="txt14">${topList.ord_total_amount} 원</strong> <span class="displaynone"></span>
												</span></td>
											</tr>
										</tbody>
										<tbody class="">
									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody>
											...
											<tr class="">
												...
												<td><span><span>${topList.ord_pay_option}</span></span>
													<p>
										...
										<tbody
											...
											<tr class="xans-record-">
												...
												<td class="left"><strong class="name"><a
														...
														class="ec-product-name">${orderList.opdt_name}</a></strong>
													<div class="option "></div>
													<p class="gBlank5 displaynone">무이자할부 상품</p></td>
												<td>${orderList.opdt_count}</td>
												<td class="right">
													<div class="discount">
														<strong>${orderList.pdt_amount}</strong>
														<div class="displaynone"></div>
													</div>
													<div class="">
														<strong>${orderList.discount_price}</strong>
														<div class="displaynone"></div>
													</div>
												</td>
												...
												<td class="SP_link state">
													<p class="txtEm">${orderList.opdt_state}</p>
													<p class="displaynone">
									...
									<table border="1" summary="" class="SP_tableSt01_isThAndTd">
										...
										<tbody>
											...
											<tr>
												...
												<td><span>${addrList.addr_name}</span></td>
											</tr>
											<tr class="displaynone">
											...
											<tr class="">
												...
												<td><span>${addrList.addr_zipcode}</span></td>
											</tr>
											<tr class="">
												<th scope="row">주소</th>
												<td><span>${addrList.addr_address_main}</span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">도시</th>
												<td></td>
											...
											<tr>
												...
												<td>${addrList.addr_htel}</td>
											</tr>
											<tr>
												<th scope="row">휴대전화</th>
												<td><span>${addrList.addr_tel}</span></td>
											</tr>
											<tr>
