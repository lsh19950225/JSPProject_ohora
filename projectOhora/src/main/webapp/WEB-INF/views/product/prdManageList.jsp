			                        ...
			                        <li id="itembox${status.index + 1}" class="item-wrap">
			                            <div class="item-container">
			                                <dl>
			                                    ...
			                                    <a href="/prdEdit.htm?productId=${pdt.pdtId}" class="item-viewlink"></a>
			                                    ...
			                                    <div class="item-info">
			                                        ...
			                                        <div class="prdDelete">
													    <form action="/prdDelete.htm" method="post" onsubmit="return confirm('정말로 이 상품을 삭제하시겠습니까?');">
													    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
													        <input type="hidden" name="productId" value="${pdt.pdtId}" />
